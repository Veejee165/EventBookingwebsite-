...
router
   ...
   .get(eventController.getEventImageById)
...
router
   .route("/bookings/intent/:id")
   .patch(bookingController.updateBookingWithPaymentIntentId)
router
...
// Payment Routes
router
   .route("/bookings/create-payment")
   .post(paymentController.createPaymentIntent)

router
   .route("/bookings/refund/:paymentIntentId")
...
router
   .route("/current-user")
   .get(authMiddleware.authenticate, userController.getCurrentUser)
...
router
   ...
   .get(authMiddleware.authenticate, userController.updateUser)

//Coupon ROutes
router
   .route("/coupons")
   .get(couponController.getAllCoupons)
   .post(couponController.createCouponCode)
router
   .route("/coupons/:id")
   .get(couponController.getCouponById)
   .delete(couponController.deleteCouponCode)
router
   .route("/coupons/check-validity")
   .post(couponController.checkCouponValidity)
router
   .route("/coupons/user-count")
   .post(couponController.updateUserCount)
